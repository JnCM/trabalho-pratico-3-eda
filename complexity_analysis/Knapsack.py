class Knapsack:
    ...
    def brute_force(self) -> int:
        ...
        self.__count_ops = 0
        return self.BFKnapsack(self.__n, self.__W), self.__count_ops
    ...
    def exaustive_search(self) -> tuple[list[int], int]:
        ...
        return subset_winner, max_value, self.__count_ops
    ...
    def backtracking(self) -> int:
        ...
        self.__count_ops = 0
        return self.BTKnapsack(0, self.__W), self.__count_ops
    ...
    def dynamic_programming_bottom_up(self) -> tuple[list[int], int]:
        ...
        return self.search_items_in_table(), self.__F[self.__n][self.__W], self.__count_ops
    ...
    def dynamic_programming_top_down(self) -> tuple[list[int], int]:
        ...
        return self.search_items_in_table(), max_value, self.__count_ops
